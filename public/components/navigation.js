...
export default function Navigation(data, lang) {
    ...
    <div class="flex justify-between items-center">
        <div class="text-xl font-semibold text-gray-700">Gabriel Lambert</div>
...
<div id="mobile-menu" class="hidden md:hidden bg-white">
    <div class="px-2 pt-2 pb-3 space-y-1">        
        <button onclick="window.print()"
            class="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-blue-600 hover:text-blue-800">
            <i class="fas fa-print mr-1"></i>${data.print}
        </button>
    </div>
</div>
